...
class PriceSyncStatusRepositoryImplTest {
    private fun newRepository(): PriceSyncStatusRepositoryImpl {
        val database = Room
            .inMemoryDatabaseBuilder<AppDatabase>()
            .setDriver(BundledSQLiteDriver())
            .build()
        return PriceSyncStatusRepositoryImpl(dao = database.priceSyncStatusDao())
    }

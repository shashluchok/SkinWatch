// Adapted from https://github.com/danysantiago/room-web-demo (Apache-2.0), a Room-team-published
// Kotlin Multiplatform sample demonstrating androidx.sqlite:sqlite-web's WebWorkerSQLiteDriver
// protocol.
import sqlite3InitModule from '@sqlite.org/sqlite-wasm';

let sqlite3 = null;

// Tracks active database connections and prepared statements by their unique IDs.
const databases = new Map(); // databaseId -> SQLiteDbObject
const statements = new Map(); // statementId -> SQLiteStatementObject
